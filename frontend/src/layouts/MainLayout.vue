    ...
    <q-header class="bg-primary text-white no-print" elevated height-hint="98">
      <q-toolbar>
        ...
        <div v-else class="row items-center q-gutter-sm">
          <q-avatar size="32px">
            <img v-if="currentUser?.user_metadata?.avatar_url" :src="currentUser.user_metadata.avatar_url" />
...
const { currentUser, loading, error, isAuthenticated, signInWithGoogle, signOut } = useAuth()
